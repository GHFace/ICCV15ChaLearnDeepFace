function [net, info] = cnn_lfw_model_single_3(mm,n,str0)
% mm is set to []
...
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', 0.01/scal * randn(3, 3, 3, 16, 'single'), ...
                           ...
                           'biasesWeightDecay', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', 0.01/scal * randn(3, 3, 16, 16, 'single'), ...
                           'biases', zeros(1, 16, 'single'), ...
                           'stride', 1, ...
                           'pad', 1, ...
                           'filtersLearningRate', 1, ...
...
net.layers{end+1} = struct('type', 'pool', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', 0.01/scal * randn(3, 3, 16, 32, 'single'), ...
...
net.layers{end+1} = struct('type', 'pool', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', 0.01/scal * randn(3, 3, 32, 48, 'single'), ...
...
net.layers{end+1} = struct('type', 'pool', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', 0.01/scal * randn(7, 7, 48, 160, 'single'), ...
