function [net, info] = cnn_lfw_model_single_2(mm,n,str0)
% mm is set to []
...
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', 0.01/scal * randn(5, 5, 3, 16, 'single'), ...
...
net.layers{end+1} = struct('type', 'pool', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', 0.01/scal * randn(4, 4, 16, 32, 'single'), ...
...
net.layers{end+1} = struct('type', 'pool', ...
                           ...
                           'pad', 0) ;
net.layers{end+1} = struct('type', 'conv', ...
                           'filters', 0.01/scal * randn(5, 5, 48, 160, 'single'), ...
